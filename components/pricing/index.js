...
export default function Pricing() {
  return (
      <section className="p-4 my-4 bg-white rounded dark:bg-gray-800">
              ...
              <div className="sm:flex sm:items-center sm:justify-between">
                  ...
                  <div className="overflow-hidden p-0.5 mt-6 border rounded-lg dark:border-gray-700">
                      <div className="sm:-mx-0.5 flex">
                          ...
                          <button className=" focus:outline-none px-3 w-1/2 sm:w-auto py-1 sm:mx-0.5 text-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 bg-transparent rounded-lg hover:bg-gray-200">Yearly</button>
                      </div>
                  </div>
              </div>
